...
assert.deepEqual(errors,[]);dom.window.close();console.log('Globe gesture checks passed: trackpad pinch, wheel units, scale bounds, SVG repaint, two-touch pinch, rotation, finger lift, tap preservation, click suppression, cancellation, coincident fingers, projection switching, and blur.');
